public class Dictionary extends RedBlackTree<Word> {
    ...
    String print = "Your Dictionary Contains: \n";
    int added = 0;
    ...
    public void print() {
        if (added == 1) {
            print = "Your Dictionary Contains: \n";
     ...
     */
    private void printHelper(Node<Word> word, String prefix) {
        if (word == null) return;
        if (print == null){
            print = prefix +word.data.wordStr + "\n";
        }
        else {
            print = print + prefix + word.data.wordStr + "\n";
        }
